...
class Lexicon:
    ...
    PLACEHOLDER_ADMIN = "Введіть артикул, назву або команду..."
    ...
    # --- Scheduler Tasks ---
    DELETE_WARNING_MESSAGE = "❗️ **Увага!**\n\nВаші збережені списки будуть видалені через 12 годин. Якщо ви хочете зберегти їх, будь ласка, завантажте ZIP-архів."
