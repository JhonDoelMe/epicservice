...
class Lexicon:
    ...
    CMD_START_ADMIN = "Вітаю, Адміністраторе! Вам доступний розширений функціонал."
    ...
    FORGET_NOT_TO_SAVE = "Не забувайте зберегти список, інакше він може бути видалений!"
    ...
    # --- Нові тексти для розсилки та "тихого режиму" ---
    ...
    USER_IMPORT_NOTIFICATION_STATS = (
        "➕ *Додано нових:* {added}\n"
        "🔄 *Оновлено існуючих:* {updated}\n"
        "🗑️ *Видалено неактуальних:* {deleted}\n"
    )
    ...
    # --- Повідомлення від планувальника ---
